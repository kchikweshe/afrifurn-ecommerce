// File: components/SocialAuth.tsx
...
const SocialAuth: React.FC = () => {
  ...
  return (
    <div className="flex flex-col space-y-4">
      ...
      <Button size="lg" onClick={handleGoogleLogin} variant="outline" className="w-full h-20">
                ...
                <Button size="lg" onClick={handleFacebookLogin} variant="outline" className="w-full h-20">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-5 w-5 mr-2">
                    <path
