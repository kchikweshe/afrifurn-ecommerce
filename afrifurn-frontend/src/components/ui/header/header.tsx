...
const Header: React.FC<HeaderProps> = ({ logoUrl }) => {
    ...
    const Logo = ({ isMobile = false }) => (
        <Link href="/" className={`${isMobile ? "md:hidden" : "hidden md:block"} flex items-center`}>
            <div className={`relative ${isMobile ? "h-12 w-32" : "h-16 w-48"}`}>
                <Image
                    src={logoUrl}
            ...
            <header className="fixed top-0 left-0 right-0 z-50 w-full lg:p-3 bg-white shadow-md">
                <div className="container mx-auto">
                    ...
                    <div className="flex items-center h-20 px-3">
                        {/* Left section */}
                        <div className="flex items-center gap-3 md:flex-grow-0 flex-grow-0">
                            <Button
                                variant="ghost"
                                size="icon"
                        ...
                        {/* Right section */}
                        <div className="flex items-center gap-1 md:gap-3 md:flex-grow-0 flex-grow-0">
